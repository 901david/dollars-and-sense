...
describe('Input tests', () => {
  ...
  describe('When providing only required basic props and required prop and change handler and defaultColor, and hasError prop', () => {
    let renderedComponent: any;
    const mockBlur = jest.fn();
    const mockChange = jest.fn();
    ...
    test('should render with correct errored color', () => {
      const { getByLabelText } = renderedComponent;
      const inputEL = getByLabelText(/Name/);
  ...
  describe('When providing only required basic props and required prop and change handler and defaultColor, and hasError prop, and providing parentErrors', () => {
    let renderedComponent: any;
    const mockBlur = jest.fn();
    const mockChange = jest.fn();
    ...
    test('should render with correct errors in  title', () => {
      const { getByLabelText } = renderedComponent;
      const inputEL = getByLabelText(/Name/);
      expect(inputEL.title).toEqual(
        'Must Match Password., Must be more than 5 characters'
      );
    });
  ...
  describe.skip('When providing only required basic props and required prop and change handler and defaultColor, and validator when  input is invalid and we are providing parent errors', () => {
    ...
    test('should render with correct errors in  title', async () => {
      ...
      await fireEvent.change(inputEL, { target: { value: 'bob@gmailcom' } });
      expect(inputEL.title).toEqual(
        'Email must match., Email must be more than 10 characters., Email must contain an @ and a . to be valid'
      );
    });
